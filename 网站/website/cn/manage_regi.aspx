<%@ page language="C#" autoeventwireup="true" inherits="website_cn_manage_regi, App_Web_zfeev1v5" %>
...
<body>
   <a id="login_icon" href="./manage_login.aspx">
	</a>
	...
	<form  id="form1" name="form1" runat="server" method="post" onSubmit="return CheckForm.Check(this,2)">
		...
		<div class="user">
			...
			<input id="username" runat="server" name="username" type="text" 
                onkeyup="check('username')" dataType="Require" msg="登录名不能为空"  
			 />
		</div>
		<div class="user">
	    ...
	    <input name="submit" id="submit" runat="server" type="submit" value="注册" onclick="return submit_onclick()" />
	</form>
