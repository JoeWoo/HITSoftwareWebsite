<%@ page language="C#" autoeventwireup="true" inherits="website_Lab, App_Web_zfeev1v5" %>
		...
		<div class="white">
				...
				<div class="white_intro">
					<div class="R_top">
						...
						<div id="ChildSecName" class="R_top_tit">预定实验室</div>
						<div class="R_top_r"></div>
						
					</div>
					<div class="R_middle">
					     <!--此处添加表格代码-->
                          <iframe id="workspace" runat="server" name = "workspace" src="./reserveLab.aspx" width ="655px" height="600px" scrolling="no" frameborder= "0 ">
